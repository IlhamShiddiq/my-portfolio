  ...
  render() {
    this.innerHTML = `
        <div class="quick-social-medias d-flex flex-column">
            ...
            <a href="https://www.instagram.com/ilham.shiddiq/" target="_blank" class="btn btn-app btn-app-big btn-social-media btn-primary-outline" rel="noopener noreferrer"><i class="fa-brands fa-instagram"></i></a>
